    ...
    return (
        <div className="h-full flex flex-col p-4">
            ...
            <div className="flex items-center justify-between mb-6 pb-4 border-b border-blue-500/30">
                <div>
                    <h3 className="text-2xl font-black text-white font-space tracking-wider">INVENTORY</h3>
                    <p className="text-blue-500 font-mono text-xs">EQUIPPED SKILLS & MODULES</p>
                </div>
                <div className="px-3 py-1 bg-blue-500/10 border border-blue-500/30 rounded text-blue-400 font-mono text-xs">
                    Generic Slots: {skills.length}
                </div>
            </div>
